...
def main():
    ...
    if uploaded_image is not None:
        ...
        #loading files
        model_path=r"C:\Azhar\ML\ImageCaption\models\model.keras"
        tokenizer_path=r"C:\Azhar\ML\ImageCaption\models\tokenizer.pkl"
        feature_extractor_path=r"C:\Azhar\ML\ImageCaption\models\feature_extractor.keras"

        #generate caption and display it
